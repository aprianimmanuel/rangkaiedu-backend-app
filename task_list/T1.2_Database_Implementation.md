...
- Define authentication-related tables (auth_tokens, otps)
...
- Defined 10 core entities: users (with roles: admin, teacher, student, parent), schools, classes, subjects, teachers, students, parents, auth_tokens, otps, oauth_providers
